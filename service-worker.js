import { config as unoConfig } from "/SmartMakerUnoTest/package_6a89563ff42513662a822b862ae5bc1bcbfa4f3d/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('1fa86cbd-08f9-4103-aeab-d3826391851b').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== '1fa86cbd-08f9-4103-aeab-d3826391851b';
